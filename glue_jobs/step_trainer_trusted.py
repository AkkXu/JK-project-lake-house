...
step_trainer_landing_node1765803759660 = glueContext.create_dynamic_frame.from_catalog(database="aws-project", table_name="step_trainer_landing", transformation_ctx="step_trainer_landing_node1765803759660")
...
'''
SQLQuery_node1765803768430 = sparkSqlQuery(glueContext, query = SqlQuery2627, mapping = {"s":step_trainer_landing_node1765803759660, "c":customers_curated_node1765803759025}, transformation_ctx = "SQLQuery_node1765803768430")
