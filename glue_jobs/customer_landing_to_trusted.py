...
AmazonS3_node1765871408092 = glueContext.create_dynamic_frame.from_options(format_options={"multiLine": "false"}, connection_type="s3", format="json", connection_options={"paths": ["s3://jk-project-lake-house/customer_landing/"], "recurse": True}, transformation_ctx="AmazonS3_node1765871408092")
...
'''
FilterConsent_node1765717374252 = sparkSqlQuery(glueContext, query = SqlQuery3253, mapping = {"myDataSource":AmazonS3_node1765871408092}, transformation_ctx = "FilterConsent_node1765717374252")
